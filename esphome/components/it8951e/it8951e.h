...
class IT8951ESensor : public PollingComponent, public display::DisplayBuffer,
                      ...
                      public spi::SPIDevice<spi::BIT_ORDER_MSB_FIRST, spi::CLOCK_POLARITY_LOW, spi::CLOCK_PHASE_LEADING,
                                            spi::DATA_RATE_20MHZ> {
 public:
  float get_loop_priority() const { return 0.0f; };  // removed override: method removed in ESPHome 2026.x
...
*/
 ...
 private:
  ...
  uint8_t *last_buffer_{nullptr};   // laatst getoond beeld, voor diff-based partial refresh (lokale patch)
  bool force_full_{true};           // forceer volledige GC16-refresh (boot / na clear) (lokale patch)
  ...
  void write_full_(update_mode_e mode);   // volledige refresh + last_buffer_-sync (lokale patch)
  void write_display();
